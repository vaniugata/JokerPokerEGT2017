...
BonusGame::BonusGame(SDL_Renderer* renderer) :
		m_texture(), m_ChoiceWin(renderer, "Resources/DoubleUpDice.png", 0, 0,
				530, 75), m_btnX2(renderer, "Resources/DoubleUpDice.png", 0, 0,
				S_BONUSBTN_W, S_BONUSBTN_H), m_btnX5(renderer,
