...
//				0, 0, BUTTONVOLUMESIZE, BUTTONVOLUMESIZE), m_btnMusic(renderer,
//				"Resources/PlayB.png", 0, 0, BUTTONVOLUMESIZE,
//				BUTTONVOLUMESIZE), m_btnMusicMinus(renderer,
//				"Resources/DecreasesB.png", 0, 0, BUTTONVOLUMESIZE,
